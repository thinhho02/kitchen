            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6">
                    <div class="d-flex justify-content-md-end justify-content-between">
                        <button type="button" class="btn btn-success mr-3" data-toggle="modal" aria-label="add multiple button"
                                data-target="#insertExcelModal">
                            <span class="mr-2">Thêm với Excel</span>
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                 viewBox="0,0,256,256" width="16px" height="16px">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center">
                                            <button type="button" class="btn btn-link py-0 edit"
                                                    data-id="<?= $resource['id']; ?>"
                                            ...
                                            <form id="deleteForm-<?= $resource['id']; ?>" method="post"
                                                  action="../../api/resource/deleteResource.php">
                                                <input type="hidden" name="resource_id"
                                                       value="<?= $resource['id']; ?>">
                                                <button type="button" class="btn btn-link text-danger"
                                                        onclick="confirmDelete(<?= $resource['id'] . ',\'' . $resource['name'] . '\''; ?>)">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
...
<div class="modal fade" id="insertExcelModal" tabindex="-1" role="dialog" aria-labelledby="insert excel modal"
     aria-hidden="true">
    <div class="modal-dialog" role="dialog">
        <form method="post" action="../../api/resource/insertExcelResource.php" enctype="multipart/form-data"
              id="insertExcelForm">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input name="name" type="text" class="form-control" id="resource-name"
                               aria-describedby="name resource" placeholder="Nhập tên nguyên vật liệu" required>
                    </div>
                    <div class="form-group">
                        <label for="resource-unit">Đơn vị:</label>
                        <input name="unit" type="text" class="form-control" id="resource-unit"
                               aria-describedby="unit resource" placeholder="Nhập đơn vị tính" required>
                    </div>
                    <div class="form-group">
                        <label for="resource-price">Giá:</label>
                        <input name="price" type="number" value="1000" min="0" max="100000" class="form-control"
                               id="resource-price"
                               aria-describedby="price resource" placeholder="Nhập giá nguyên vật liệu" required>
                    </div>
    ...
    <div class="modal-dialog" role="dialog">
        <form method="post" action="/kitchen/api/resource/updateResource.php" id="updateForm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <input name="id" type="text" hidden class="form-control" id="resource-update-id"
                           aria-label="id resource" required>
                    <div class="form-group">
                        <label for="resource-update-name">Tên:</label>
                        <input name="name" type="text" class="form-control" id="resource-update-name"
                               aria-describedby="name resource" placeholder="Nhập tên nguyên vật liệu" required>
                    </div>
                    <div class="form-group">
                        <label for="resource-update-unit">Đơn vị:</label>
                        <input name="unit" type="text" class="form-control" id="resource-update-unit"
                               aria-describedby="unit resource" placeholder="Nhập đơn vị tính" required>
                    </div>
                    <div class="form-group">
                        <label for="resource-update-price">Giá:</label>
                        <input name="price" type="number" value="0" min="0" max="100000" class="form-control"
                               id="resource-update-price"
                               aria-describedby="price resource" placeholder="Nhập giá nguyên vật liệu" required>
                    </div>
