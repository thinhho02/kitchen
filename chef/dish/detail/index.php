            ...
            <div class="container pt-5">
                ...
                <div>
                    ...
                    <!-- <form class="d-flex justify-content-center pt-3" id="changeImageForm" enctype="multipart/form-data"
                        ...
                        <input name="id" value="<?php //$dish_id ?>" hidden aria-label="id dish">
                ...
                <form id="updateForm" method="post" action="/kitchen/api/dish/updateDish.php">
                    ...
                    <div class="form-group">
                        ...
                        <input name="name" value="<?php echo $dish['name']; ?>" type="text" class="form-control"
                               id="dish-name" aria-describedby="dish name" placeholder="Nhập tên món ăn" disabled>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input name="price" value="<?php echo $dish['price']; ?>" type="number" class="form-control"
                               id="dish-price" aria-describedby="dish name" placeholder="Nhập giá món" disabled>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" disabled class="form-control" id="dish-description" rows="3"
