                                ...
                                <td class="text-center">
                                    <div class="d-flex justify-content-center">
                                        <button type="button" class="btn btn-link" aria-label="view detail button"
                                                onclick="viewDetail(<?= $dish['dish_id']; ?>)">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
...
<!-- Start: Modal -->
<div class="modal fade" id="insertModal" tabindex="-1" role="dialog" aria-labelledby="insert modal"
     aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input name="name" type="text" class="form-control" id="dish-name-insert"
                               aria-describedby="name resource" placeholder="Nhập tên món" required>
                    </div>
                    <div class="form-group">
                        <label for="dish-image-insert">Ảnh:</label>
                        <input name="image" type="file" class="form-control" id="dish-image-insert"
                               aria-describedby="image resource" placeholder="Chọn ảnh" accept=".jpeg, .jpg, .png" required>
                    </div>
                    <div class="form-group">
